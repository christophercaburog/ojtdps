...
<nav id="sidebar" class="sidebar nav-collapse collapse">
    <ul id="side-nav" class="side-nav">
        ...
        <li>
         ...
         <li>
            <a href="requirement-manager.php"><i class="icon-building"></i> <span class="name">Requirements</span></a>
            
        </li>
         <li class="active">
            <a href="file-manager.php"><i class="icon-folder-open"></i> <span class="name">Files</span></a>
...
<div class="wrap">
    ...
    <div class="content container-fluid">
        <div class="row-fluid">
			...
			<ul class="breadcrumb">
					<li>
						<a href="admin.php">Admin</a> <span class="divider">/</span>
					</li>
					<li>
...
<!-- modals -->
	<div id="modal-account" class="modal hide fade" tabindex="-1" role="dialog">
						<form action="file-manager.php" method="post" id="form-final" enctype="multipart/form-data" >
